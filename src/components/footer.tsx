...
export const Footer = () => {
  return (
    <div
      className="home mx-auto md:mx-auto sm:flex sm:flex-row-reverse justify-around  sm:pb-6 py-12 text-black"
      id="footer"
    >
      <div className="footerBox2 grid grid-row-2 sm:place-items-start place-items-center font-regular">
        <h4 className="lg:text-2xl md:text-xl text-lg font-demi mb-2">Contact Us</h4>
        <p className="lg:text-base md:text-sm text-xs">
          Have questions? Write to us at&nbsp;
          <b>
            <a className="text-inherit" href="mailto:admin@codeforgovtech.in">
              admin@codeforgovtech.in
            </a>
          </b>
        </p>
      </div>
